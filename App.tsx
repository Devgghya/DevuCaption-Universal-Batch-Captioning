  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800/50 transition-all duration-500">
        ...
        {/* API Key Input Panel */}
        {showApiKeyInput && (
          <div className="absolute top-16 right-4 sm:right-6 w-80 bg-slate-900 border border-slate-800 p-4 rounded-2xl shadow-2xl animate-in slide-in-from-top-4 fade-in z-50">
             ...
             <input 
               ...
               className="w-full bg-slate-950 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-blue-500 transition-colors mb-2"
             />
